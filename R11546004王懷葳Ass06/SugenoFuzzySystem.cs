    ...
    public class SugenoFuzzySystem : IFuzzySystem
    {
        ...
        public void ConstructRule(DataGridView dgv)
        {
            ...
            foreach (DataGridViewRow row in dgv.Rows)
            {
                ...
                int EQid = (int)row.Cells[dgv.ColumnCount - 1].Tag;
                rules[idx] = new SugenoRule(ant, EQid);
                idx++;
                //  rules.Add(rule);
            }
        }
        ...
        public void Save(StreamWriter sw)
        {
            ...
            sw.WriteLine($"SugenoWeightedTypeIndex:{WeightedInfereceType}");
